...
class RadiantStateService(ValasStateService):
    ...
    def get_rewards_balance_function_info(
        ...
        multicall_calls.append(self.get_function_incentive_info(
            "allPendingRewards", self._w3.to_checksum_address(wallet), block_number))
    ...
    def calculate_rewards_balance(
        ...
        key = f"allPendingRewards_{self.pool_info['stakedIncentiveAddress']}_{wallet}_{block_number}".lower()
