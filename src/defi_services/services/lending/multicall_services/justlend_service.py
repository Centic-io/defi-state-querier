...
class JustLendStateService(CompoundStateService):
    ...
    def get_rewards_balance_function_info(
        ...
        multicall_call = self.get_comptroller_function_info("compAccrued", self._w3.to_checksum_address(wallet))
    ...
    def get_wallet_deposit_borrow_balance_function_info(
        ...
        for token, value in reserves_info.items():
            ...
            multicall_calls.append(self.get_ctoken_function_info(ctoken, "borrowBalanceCurrent", wallet))
            multicall_calls.append(self.get_ctoken_function_info(ctoken, "balanceOfUnderlying", wallet))
