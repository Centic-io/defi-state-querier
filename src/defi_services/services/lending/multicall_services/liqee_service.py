...
class LiqeeStateService(CompoundStateService):
    ...
    def get_rewards_balance_function_info(
        ...
        multicall_call = self.get_lending_function_info("getAccountRewardAmount", self._w3.to_checksum_address(wallet), block_number)
    ...
    def calculate_rewards_balance(self, wallet: str, reserves_info: dict, decoded_data: dict, block_number: int = "latest"):
        get_reward_id = f"getAccountRewardAmount_{self.pool_info['lendingDataAddress']}_{wallet}_{block_number}".lower()
